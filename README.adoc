...
RTE:: as many as required to define the route by linking the waypoints
 
NOTE: If the first waypoint in the route has not been reached, the script prepends a leg from the point of activation to the first waypoint
